...
import { ILoginUserDTO, IRegisterUserDTO, IUserResponse, IAuthResponse } from './auth.interface';
...
export class AuthController {
     ...
     */
    static verifyEmail = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
     ...
     */
    static completePasswordReset = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
